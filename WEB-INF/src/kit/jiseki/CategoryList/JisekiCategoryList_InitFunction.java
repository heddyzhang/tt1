 ...
 * 初期表示処理の実装クラスです
 */
public class JisekiCategoryList_InitFunction extends KitFunction {
	...
	// -----------------------------------------
	private static String className__ = JisekiCategoryList_InitFunction.class.getName();
	 ...
	 *            HttpサーブレットResponse
	 */
	public JisekiCategoryList_InitFunction(ActionMapping mapping, ActionForm form,
	...
	public String execute_() throws KitException {
		...
		// 画面を初期化
		JisekiCategoryList_SearchForm searchForm = new JisekiCategoryList_SearchForm();
		...
		// 集計期間
		searchForm.setSyukeiKikan(RDO_SYUKEI_KIKAN_TOGETSU);
		// 検索日時
