 ...
 */
public interface IJisekiCategoryList extends IKitComConst {

	// ---------------------------------------------------
	// セッションのキー
	static final String KEY_SS_SEARCHFORM = "jisekiCategoryList_Search";						// 検索部
	static final String KEY_SS_SEARCHEDJGYOSYOLIST = "jisekiCategoryJigyosyo_SearchList";		// 明細リスト(事業所レベル)
	static final String KEY_SS_SEARCHEDKALIST = "jisekiCategoryKa_SearchList";					// 明細リスト(課レベル)

	/** 表示単位（画面固有）*/
	static final String RDO_TANI_KINGAKU = "1"; // 円
	static final String RDO_TANI_LSU = "2"; 	// L数


	/** 集計期間（画面固有）*/
	static final String RDO_SYUKEI_KIKAN_TOGETSU = "0";		// 当月
	static final String RDO_SYUKEI_KIKAN_JYUGATSU = "1";	// 10月累計
	static final String RDO_SYUKEI_KIKAN_ICHIGATSU= "2";	// 1月累計
