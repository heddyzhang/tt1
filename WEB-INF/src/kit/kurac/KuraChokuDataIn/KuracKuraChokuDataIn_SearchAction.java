...
public final class KuracKuraChokuDataIn_SearchAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		KuracKuraChokuDataIn_SearchFunction func_ = new KuracKuraChokuDataIn_SearchFunction(mapping, form, request, response);
