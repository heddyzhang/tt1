 ...
 *
 */
public final class KuracKuraChokuDataUp_SearchAction
	extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		KuracKuraChokuDataUp_SearchFunction func_ = new KuracKuraChokuDataUp_SearchFunction(mapping, form, request, response);
