 ...
 *
 */
public final class KuracKuraChokuDataUp_InitAction
	extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		KuracKuraChokuDataUp_InitFunction func_ = new KuracKuraChokuDataUp_InitFunction(mapping, form, request, response);
