...
public final class JuchuJuchuAddOnly_ModalAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuAddOnly_ModalFunction func_ = new JuchuJuchuAddOnly_ModalFunction(mapping, form, request, response);
