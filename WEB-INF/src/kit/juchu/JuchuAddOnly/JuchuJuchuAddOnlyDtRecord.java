...
/**
 * 受付専用受注追加入力（受注データ／ディテール部）のレコードクラス
 */
public class JuchuJuchuAddOnlyDtRecord extends KitRecord {

	/** シリアルID */
	private static final long serialVersionUID = 1403121964468320029L;

	/** デバッグ */
	boolean isDebug_ = false;

	/** コンストラクタ */
	public JuchuJuchuAddOnlyDtRecord() {
		super();
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input Map
	 */
	public JuchuJuchuAddOnlyDtRecord(Map<String, Object> input) {
		super(input);
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input HashMap
	 */
	public JuchuJuchuAddOnlyDtRecord(HashMap<String, Object> input) {
	 ...
	 * コンストラクタ。
	 *
	 * @param input JuchuJuchuAddOnlyDtRecord
	 */
	public JuchuJuchuAddOnlyDtRecord(JuchuJuchuAddOnlyDtRecord input) {
	...
	public void modifyRecord(KitRecord reco) {
		JuchuJuchuAddOnlyDtRecord newRec = (JuchuJuchuAddOnlyDtRecord) reco;
		// 追加モード
		if (isAddMode()) {
...
//主キー項目			setInputLineNo(newRec.getInputLineNo()); // 受注行NO
	...
	public boolean equals(KitRecord reco) {
		...
		JuchuJuchuAddOnlyDtRecord target = (JuchuJuchuAddOnlyDtRecord) reco;
		// 追加モードの場合（入力項目）
		if (this.isAddMode()) {
			// 商品CD
	 ...
	 */
	public boolean isDuplicated(JuchuJuchuAddOnlyDtRecord rec){
		boolean ret = true;
	 ...
	 */
	public void reset() {
		this.modifyRecord(new JuchuJuchuAddOnlyDtRecord());
