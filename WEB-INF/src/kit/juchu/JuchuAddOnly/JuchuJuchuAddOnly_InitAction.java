...
public final class JuchuJuchuAddOnly_InitAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuAddOnly_InitFunction func_ = new JuchuJuchuAddOnly_InitFunction(mapping, form, request, response);
