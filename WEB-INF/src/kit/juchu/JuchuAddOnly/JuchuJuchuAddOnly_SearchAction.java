...
public final class JuchuJuchuAddOnly_SearchAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuAddOnly_SearchFunction func_ = new JuchuJuchuAddOnly_SearchFunction(mapping, form, request, response);
