...
/**
 * 受付専用受注追加入力（受注データ／ヘッダー部）のレコードクラス
 */
public class JuchuJuchuAddOnlyRecord extends KitRecord {

	/** シリアルID */
	private static final long serialVersionUID = 2144694884910324319L;

	/** デバッグ */
	boolean isDebug_ = false;

	/** コンストラクタ */
	public JuchuJuchuAddOnlyRecord() {
		super();
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input Map
	 */
	public JuchuJuchuAddOnlyRecord(Map<String, Object> input) {
		super(input);
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input HashMap
	 */
	public JuchuJuchuAddOnlyRecord(HashMap<String, Object> input) {
	 ...
	 * コンストラクタ。
	 *
	 * @param input JuchuJuchuAddOnlyRecord
	 */
	public JuchuJuchuAddOnlyRecord(JuchuJuchuAddOnlyRecord input) {
	...
	public void modifyRecord(KitRecord reco) {
		JuchuJuchuAddOnlyRecord newRec = (JuchuJuchuAddOnlyRecord) reco;
		// 追加モード
		if (isAddMode()) {
...
//主キー項目			setJyucyuNo(newRec.getJyucyuNo()); // 受注NO
	...
	public boolean equals(KitRecord reco) {
		...
		JuchuJuchuAddOnlyRecord target = (JuchuJuchuAddOnlyRecord) reco;
		// 追加モードの場合（入力項目）
		if (this.isAddMode()) {
			// 縦線CD (FK)
	 ...
	 */
	public boolean isDuplicated(JuchuJuchuAddOnlyRecord rec){
		boolean ret = true;
