 ...
 *
 */
public class JuchuJuchuAddOnly_ModalFunction extends KitFunction {

	/** シリアルID */
	private static final long serialVersionUID = -2834441614247329409L;

	// -----------------------------------------
	// create log4j instance & Config LogLevel
	// -----------------------------------------
	private static String className__ = JuchuJuchuAddOnly_ModalFunction.class.getName();
	 ...
	 */
	public JuchuJuchuAddOnly_ModalFunction(ActionMapping mapping, ActionForm form,
...
//		setErrorMessageId("warn.choiceTatesen");
		...
		// editFormを編集可能モードにする
		JuchuJuchuAddOnly_EditForm editForm = new JuchuJuchuAddOnly_EditForm();
