...
/**
 * 受注入力（受注データ／ディテール部）専用のリスト構造を提供する。
 */
public class JuchuJuchuDataInDtList extends KitList {

	/** シリアルID */
	private static final long serialVersionUID = 8816072185812114366L;

	/**
	 * コンストラクタ。
	 */
	public JuchuJuchuDataInDtList() {
		super();
	}
	 ...
	 * @param initSize
	 */
	public JuchuJuchuDataInDtList(int initSize) {
	 ...
	 */
	public JuchuJuchuDataInDtList(PbsRecord[] records) {
		super(records);
	}
	 ...
	 */
	public JuchuJuchuDataInDtList(JuchuJuchuDataInDtRecord record) {
		super(record);
	}
	...
	public KitList createList() {
		return new JuchuJuchuDataInDtList();
	}
	...
	public KitList copy(int from, int to) {
		JuchuJuchuDataInDtList list = (JuchuJuchuDataInDtList) super.copy(from, to);
		return list;
	}
	...
	public KitRecord createRecord() {
		return new JuchuJuchuDataInDtRecord();
	}
	...
	public KitRecord createRecord(HashMap<String, Object> record) {
		return new JuchuJuchuDataInDtRecord(record);
	}
	...
	public KitRecord createRecord(KitRecord record) {
		return new JuchuJuchuDataInDtRecord((JuchuJuchuDataInDtRecord) record);
	}
	...
	public void format(String reqType){
		...
		JuchuJuchuDataInDtRecord rec = null;
	 ...
	 * @param isShortName
	 */
	public void setShohinNms(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd, boolean isShortName) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param ktksyCd
	 */
	public void setTnpnVolMls(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param ktksyCd
	 */
	public void setCaseIrisus(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param decodeList
	 */
	public void setSyukaTaioKbns(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd, KitSelectList decodeList) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param decodeList
	 */
	public void setAtukaiKbns(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd, KitSelectList decodeList) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param ktksyCd
	 */
	public void setZaikoZansu(JuchuJuchuDataIn_CheckService checkServ, String kuraCd, String syukaDt, String kaisyaCd, String ktksyCd) {
		JuchuJuchuDataInDtRecord rec = null;
		String[] zaikoInfo;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
	 ...
	 * @param ktksyCd
	 */
	public void setHanbaiTanka(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd) {
		JuchuJuchuDataInDtRecord rec = null;
		for (PbsRecord tmp : this) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
			// 商品CDがある場合のみ
	 ...
	 * @param atukaiKbnList
	 */
	public void setDtInfoForSelect(JuchuJuchuDataIn_CheckService checkServ, String kaisyaCd, String ktksyCd, boolean isShortName, KitSelectList atukaiKbnList) {
		// 商品名を設定
	 ...
	 * @param atukaiKbnList
	 */
	public void setDtInfoWithZaiko(JuchuJuchuDataIn_CheckService checkServ, JuchuJuchuDataInRecord hdRec, String kaisyaCd, String ktksyCd, boolean isShortName, KitSelectList atukaiKbnList) {
		// 商品名を設定
		this.setShohinNms(checkServ, kaisyaCd, ktksyCd, isShortName);
	 ...
	 */
	public JuchuJuchuDataInDtList getWorkPageList(int from, int to) {
		JuchuJuchuDataInDtList ret = new JuchuJuchuDataInDtList();
		for (int i = 0; i < this.size(); i++) {
			JuchuJuchuDataInDtRecord rec = (JuchuJuchuDataInDtRecord) this.get(i);
			if (from <= i && i <= to) {
				ret.add(rec);
			}
		}
	 ...
	 * @return 抽出リスト
	 */
	public JuchuJuchuDataInDtList getListContainKbn(String[] atukaiKbn, String[] bupinKbn) {
		JuchuJuchuDataInDtList ret = new JuchuJuchuDataInDtList();
		for (int i = 0; i < this.size(); i++) {
			JuchuJuchuDataInDtRecord rec = (JuchuJuchuDataInDtRecord) this.get(i);
