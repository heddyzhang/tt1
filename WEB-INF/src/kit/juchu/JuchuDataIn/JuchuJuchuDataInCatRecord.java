...
/**
 * 受注入力（予定出荷先別商品カテゴリデータ）のレコードクラス
 */
public class JuchuJuchuDataInCatRecord extends CategoryDataCommonRecord {

	/** シリアルID */
	private static final long serialVersionUID = -3135113721366498300L;

	/** デバッグ */
	boolean isDebug_ = false;

	/** コンストラクタ */
	public JuchuJuchuDataInCatRecord() {
		super();
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input Map
	 */
	public JuchuJuchuDataInCatRecord(Map<String, Object> input) {
		super(input);
		// 親に主キーのありかをセットする
		setPrimaryKeys();
	}
	 ...
	 * @param input HashMap
	 */
	public JuchuJuchuDataInCatRecord(HashMap<String, Object> input) {
	 ...
	 * コンストラクタ。
	 *
	 * @param input JuchuJuchuDataInCatRecord
	 */
	public JuchuJuchuDataInCatRecord(JuchuJuchuDataInCatRecord input) {
