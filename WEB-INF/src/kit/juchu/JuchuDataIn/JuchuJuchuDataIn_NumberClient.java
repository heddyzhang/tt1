 ...
 * Singleton パターン利用。
 */
public class JuchuJuchuDataIn_NumberClient extends KitService {
	/* シリアルID */
	private static final long serialVersionUID = -5074231470221096602L;

	private static JuchuJuchuDataIn_NumberClient numberClient;
    private static Object lockObj = new Object();

    // 他のクラスからの生成を防ぎます。
    private JuchuJuchuDataIn_NumberClient() {
    }

    /**
     * JuchuJuchuDataIn_NumberClientの唯一のインスタンスを返します。
     * 他のクラスからのインスタンス生成を制御します。
     * @return JuchuJuchuDataIn_NumberClient
     */
    public static JuchuJuchuDataIn_NumberClient getInstance() {
        synchronized(lockObj) {
            if (numberClient == null) {
                numberClient = new JuchuJuchuDataIn_NumberClient();
            }
            return numberClient;
        }
    }
