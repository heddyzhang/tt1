...
public final class JuchuJuchuDataIn_InitAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuDataIn_InitFunction func_ = new JuchuJuchuDataIn_InitFunction(mapping, form, request, response);
