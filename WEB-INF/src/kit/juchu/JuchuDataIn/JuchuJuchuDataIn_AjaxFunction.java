 ...
 *
 */
public class JuchuJuchuDataIn_AjaxFunction extends KitFunction {

	/** シリアルID */
	private static final long serialVersionUID = 4636977351767211317L;

	// -----------------------------------------
	// create log4j instance & Config LogLevel
	// -----------------------------------------
	private static String className__ = JuchuJuchuDataIn_AjaxFunction.class.getName();
	 ...
	 */
	public JuchuJuchuDataIn_AjaxFunction(ActionMapping mapping, ActionForm form,
