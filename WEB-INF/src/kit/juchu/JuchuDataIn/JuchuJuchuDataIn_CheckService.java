 ...
 */
public class JuchuJuchuDataIn_CheckService extends KitService {

	/** シリアルID */
	private static final long serialVersionUID = -4737531552227696673L;

	/** クラス名. */
	private static String className__ = JuchuJuchuDataIn_CheckService.class.getName();
	...
	/** 選択されたレコード */
	private JuchuJuchuDataInRecord recSelected;
	 ...
	 * @param ae アクションエラー情報
	 */
	public JuchuJuchuDataIn_CheckService(ComUserSession cus, PbsDatabase db_, boolean isTran,
			ActionErrors ae) {
	 ...
	 * @return recSelected
	 */
	public JuchuJuchuDataInRecord getRecSelected() {
		return new JuchuJuchuDataInRecord(recSelected.getHashMap());
	}
...
// ===================================
	 ...
	 */
	public boolean validateSearch(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 * @return
	 */
	public boolean validateCsvMake(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 */
	public boolean validateSearchForAdd(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 * @return TRUE / FALSE
	 */
	public boolean validateSelect(JuchuJuchuDataIn_EditForm editForm, 	JuchuJuchuDataInList searchedList) throws KitException {
	 ...
	 * @param searchForm
	 */
	public void validateSelectBtnAvailFlg(JuchuJuchuDataInList editList, JuchuJuchuDataIn_SearchForm searchForm) {

		JuchuJuchuDataInRecord rec = (JuchuJuchuDataInRecord) editList.getFirstRecord();
		String jyucyuNo = rec.getJyucyuNo(); // 受注NO

		// ====================================================================================================
		// 【受注センター用】
		// 　修正　　：利用区分＝利用可　かつ　データ種別CD＝通常伝票/通常(単価違)伝票　かつ　受注NO末尾＝0
		// 　参照追加：データ種別CD＝受注キャンセル/売伝キャンセル以外･･･利用区分＝利用可
	 ...
	 * @return TRUE / FALSE
	 */
	public boolean validateManipulationEdit(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
			JuchuJuchuDataInList selectedList) throws KitException {
	 ...
	 * @return TRUE / FALSE
	 */
	public boolean validateManipulationReference(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
			JuchuJuchuDataInList searchedList) {
	 ...
	 * @return TRUE / FALSE
	 */
	public boolean validateManipulationDelete(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInList searchedList) {
	 ...
	 * @return TRUE / FALSE
	 */
	public boolean validateManipulationRebirth(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInList searchedList) {
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	public boolean validateConfirmAsInsert(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	public boolean validateConfirmAsUpdate(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList initList, JuchuJuchuDataInDtList initDtList,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
			MastrTatesenOrositenRecord tatesenRec) throws KitException {
		...
		if (!noModDt) {
			for (int i = 0; i < editList.size(); i++) {
				JuchuJuchuDataInRecord eRec = (JuchuJuchuDataInRecord) editList.get(i);
				eRec.setModified();
			}
		}
		...
		// 関連チェックを行う（ヘッダー部）
		// ==================================================
		if (!inputCheckXForEdit(editList, tatesenRec)) {
			return false;
		}
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	public boolean validateConfirmAsReference(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList initList, JuchuJuchuDataInDtList initDtList,
			JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
			MastrTatesenOrositenRecord tatesenRec) throws KitException {
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	public boolean validateConfirmAsDelete(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList) {
		...
		// ディテール部
		JuchuJuchuDataInDtRecord recDt = null;
		for (PbsRecord tmp : editDtList) {
			recDt = (JuchuJuchuDataInDtRecord) tmp;
			recDt.setModified();
		}
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	public boolean validateConfirmAsRebirth(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @return TRUE / FALSE
	 */
	private boolean inputCheckForManipulation(JuchuJuchuDataInList editList,
			JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInList selectedList) {
	 ...
	 */
	private boolean inputCheckNoEntryForInsert(JuchuJuchuDataInList editList) {

		boolean res = false;

		JuchuJuchuDataInRecord rec;
		for (PbsRecord tmp : editList) {
			rec = (JuchuJuchuDataInRecord) tmp;
	 ...
	 * @return TRUE:なんらかの入力がある / FALSE:なにも入力されていない
	 */
	private boolean inputCheckNoEntryForInsert(JuchuJuchuDataInDtList editDtList) {

		boolean res = false;

		JuchuJuchuDataInDtRecord rec;
		for (PbsRecord tmp : editDtList) {
			rec = (JuchuJuchuDataInDtRecord) tmp;
		...
		if (res) {
			...
			// 先頭入力欄にエラーフラグを設定
			rec = (JuchuJuchuDataInDtRecord) editDtList.getFirstRecord();
			rec.setShohinCdClass(STYLE_CLASS_ERROR);
			// エラーメッセージを出力
			setErrorMessageId("errors.noInputAll.at",PbsUtil.getMessageResourceString("com.text.kakkoJuchuDataIn"));
			return false;
		}
	}
	 ...
	 */
	private boolean inputCheckNoEntryForEdit(JuchuJuchuDataInList initList, JuchuJuchuDataInList editList) {

		boolean res = false;

		for (int i = 0; i < editList.size(); i++) {
			JuchuJuchuDataInRecord iRec = (JuchuJuchuDataInRecord) initList.get(i);
			JuchuJuchuDataInRecord eRec = (JuchuJuchuDataInRecord) editList.get(i);
...
//			setErrorMessageId("errors.NothingUpdateTarget.at",PbsUtil.getMessageResourceString("com.text.kakkoJuchuJoho"));
	 ...
	 * @return TRUE:どこか変更されました。 / FALSE:何も変更されていません。
	 */
	private boolean inputCheckNoEntryForEdit(JuchuJuchuDataInDtList initDtList, JuchuJuchuDataInDtList editDtList) {

		boolean res = false;

		for (int i = 0; i < editDtList.size(); i++) {
			JuchuJuchuDataInDtRecord iRec = (JuchuJuchuDataInDtRecord) initDtList.get(i);
			JuchuJuchuDataInDtRecord eRec = (JuchuJuchuDataInDtRecord) editDtList.get(i);
...
// ヘッダー部とディテール部のどちらかが変更されていればOKとするため、ここではエラーメッセージを表示しない
//			// エラーメッセージを出力
//			setErrorMessageId("errors.NothingUpdateTarget.at",PbsUtil.getMessageResourceString("com.text.kakkoJuchuDataIn"));
			return false;
		}
	}
	 ...
	 */
	private boolean inputCheckForInsert(JuchuJuchuDataInList editList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckForInsert(JuchuJuchuDataInDtList editDtList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckForEdit(JuchuJuchuDataInList initList, JuchuJuchuDataInList editList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckForEdit(JuchuJuchuDataInDtList initDtList, JuchuJuchuDataInDtList editDtList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckForReference(JuchuJuchuDataInList initList, JuchuJuchuDataInList editList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckForReference(JuchuJuchuDataInDtList initDtList, JuchuJuchuDataInDtList editDtList) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForInsert(JuchuJuchuDataInList editList, MastrTatesenOrositenRecord tatesenRec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForInsert(JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForEdit(JuchuJuchuDataInList editList, MastrTatesenOrositenRecord tatesenRec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForEdit(JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @param tatesenRec
	 */
	private void inputCheckXForConfirm(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList,
...
//		}
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForYosin(JuchuJuchuDataInRecord rec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForCalc(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList) throws KitException {
		...
		for (int i = 0; i < editDtList.size(); i++) {
			...
			// 1行全体が未入力の場合は、追加対象外のためチェック不要
			JuchuJuchuDataInDtRecord dtRec = (JuchuJuchuDataInDtRecord) editDtList.get(i);
	 ...
	 * @param editList
	 */
	private void checkForCalc(JuchuJuchuDataInList initList, JuchuJuchuDataInList editList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForDelete(JuchuJuchuDataInList editList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForDelete(JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForRebirth(JuchuJuchuDataInList editList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean inputCheckXForRebirth(JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @param editDtList
	 */
	private void inputCheckXForRebirth(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean searchCheckXForEdit(JuchuJuchuDataInList editList) throws KitException {
...
// ==============================
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	private boolean inputCheckRequiredForSearch(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	private boolean inputCheckRequiredForCsvMake(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	private boolean inputCheckForSearch(JuchuJuchuDataIn_SearchForm searchForm) {
	 ...
	 * @return true(エラー無) or false(エラー有)
	 */
	private boolean inputCheckRequiredForInsert(JuchuJuchuDataIn_SearchForm searchForm) {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
	 ...
	 * @return TRUE / FALSE
	 */
	private boolean inputCheckRequiredForSelect(JuchuJuchuDataIn_EditForm editForm,
			JuchuJuchuDataInList editList) throws KitException {
		...
		for (;;) {
			...
			if (!PbsUtil.isEmpty(editForm.getSelectedRowId())) {
				...
				// 選択行IDでレコードを取得
				recSelected = (JuchuJuchuDataInRecord) editList.getRecSelectedRow(editForm.getSelectedRowId());
	 ...
	 */
	protected void setCdToNmSelect(JuchuJuchuDataInRecord rec) throws KitException {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
	 ...
	 * @param rec JuchuJuchuDataInRecord
	 */
	protected void setCdToNmView(JuchuJuchuDataInRecord rec) throws KitException {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
	 ...
	 */
	protected void setCdToNmSelect(JuchuJuchuDataInDtRecord rec) {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
		String ktksyCd = cus.getKtksyCd(); // 寄託者CD
	 ...
	 * @param line 行番号
	 */
	protected void setCdToNmView(JuchuJuchuDataInDtRecord rec, int line) {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
		String ktksyCd = cus.getKtksyCd(); // 寄託者CD
	 ...
	 * @param editDtList
	 */
	protected void setViews(JuchuJuchuDataInDtList initDtList, JuchuJuchuDataInDtList editDtList) {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
		String ktksyCd = cus.getKtksyCd(); // 寄託者CD
...
// ==================================
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkOrositenCdLast(String data, JuchuJuchuDataIn_SearchForm searchForm, String kaisyaCd) {
	 ...
	 * @param zRec 変換用レコード
	 */
	private void setOrositenCdLastToNm(JuchuJuchuDataIn_SearchForm searchForm, FbMastrOrositenRecord zRec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkOrsTatesnCd(JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkOrsTatesnCd(String data, JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setOrsTatesnCdToNm(JuchuJuchuDataInRecord rec, FbMastrOrositenRecord zRec, boolean isView) {
		boolean isShortName = true; // 略称or正式
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkSyuhantenCd(JuchuJuchuDataInRecord rec, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkSyuhantenCd(String data, JuchuJuchuDataInRecord rec, boolean isView) {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setSyuhantenCdToNm(JuchuJuchuDataInRecord rec, FbMastrSyuhantenRecord zRec, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkUnsotenCd(JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkUnsotenCd(String data, JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setUnsotenCdToNm(JuchuJuchuDataInRecord rec, FbMastrUnsotenRecord zRec, boolean isView) {
		boolean isShortName = true; // 略称or正式
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTantosyaCd(JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTantosyaCd(String data, JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTantosyaCdToNm(JuchuJuchuDataInRecord rec, FbMastrKbnJisekiTantoRecord zRec, boolean isView) {
		boolean isShortName = true; // 略称or正式
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkNyuryokusyaCd(JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkNyuryokusyaCd(String data, JuchuJuchuDataInRecord rec, String kaisyaCd, boolean isView) {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setNyuryokusyaCdToNm(JuchuJuchuDataInRecord rec, FbMastrSgyosyaRecord zRec, boolean isView) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn1(JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn1(String data, JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTekiyoKbn1ToNm(JuchuJuchuDataInRecord rec, FbMastrKbnTekiyoRecord zRec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn2(JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn2(String data, JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTekiyoKbn2ToNm(JuchuJuchuDataInRecord rec, FbMastrKbnTekiyoRecord zRec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn3(JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn3(String data, JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTekiyoKbn3ToNm(JuchuJuchuDataInRecord rec, FbMastrKbnTekiyoRecord zRec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn4(JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn4(String data, JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTekiyoKbn4ToNm(JuchuJuchuDataInRecord rec, FbMastrKbnTekiyoRecord zRec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn5(JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkTekiyoKbn5(String data, JuchuJuchuDataInRecord rec, boolean isView) throws KitException {
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setTekiyoKbn5ToNm(JuchuJuchuDataInRecord rec, FbMastrKbnTekiyoRecord zRec, boolean isView) throws KitException {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkShohinCd(JuchuJuchuDataInDtRecord rec, String kaisyaCd, String ktksyCd,
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkShohinCd(String data, JuchuJuchuDataInDtRecord rec, String kaisyaCd,
	 ...
	 * @param isView View用フラグ（true：property=xxView用、false：property=xx用）
	 */
	private void setShohinCdToNm(JuchuJuchuDataInDtRecord rec, FbMastrSyohinRecord zRec, boolean isShortName,
			boolean isView) {
...
//			e.printStackTrace(); // デバッグ用
	 ...
	 */
	public String getDataSyubetuCd(String mode, JuchuJuchuDataInDtList editDtList, String kaisyaCd, String ktksyCd, boolean doSetStyleClass) {
		String ret = "";
...
// ==============================
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean setNextJyucyuNo(JuchuJuchuDataInList editList, String symbol, String online) {
		JuchuJuchuDataInRecord rec = (JuchuJuchuDataInRecord) editList.getFirstRecord();
	...
	public String getNextJyucyuNo(String symbol, String online) {
		...
		// -------------------------------------------------------------------------------------デバッグ用
		if (debug) {
			JuchuJuchuDataIn_NumberClient numberClient = JuchuJuchuDataIn_NumberClient.getInstance();
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean setIncrementedJyucyuNo(JuchuJuchuDataInList editList, String baseJyucyuNo) {
		JuchuJuchuDataInRecord rec = (JuchuJuchuDataInRecord) editList.getFirstRecord();
	 ...
	 */
	private void setDtListInfo(JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList) {
		// ヘッダー部レコード
		JuchuJuchuDataInRecord hdRec = (JuchuJuchuDataInRecord) editList.getFirstRecord();
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean setOthers(JuchuJuchuDataIn_EditForm editForm, JuchuJuchuDataInList editList, JuchuJuchuDataInDtList editDtList
			, MastrTatesenOrositenRecord tatesenRec) {
		// ----------------------
		// ユーザーセッション情報
		// ----------------------
	 ...
	 */
	private boolean setHanbaiInfo(JuchuJuchuDataInDtRecord dtRec, String hanbaiBunruiCd) {
		// --------------------
		// 販売分類区分マスター
		// --------------------
...
// =============================
	 ...
	 * @param rec ヘッダー部レコード
	 */
	private void arrangeNiukeTimeKbn(JuchuJuchuDataInRecord rec) {
		// 不要な指定は空白に置き換える
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXChakubi(JuchuJuchuDataInRecord rec) {
	 ...
	 */
	private boolean checkXLeadTime(JuchuJuchuDataInRecord rec, MastrTatesenOrositenRecord tatesenRec) throws ParseException {
		// 着日－出荷日
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXNiuke(JuchuJuchuDataInRecord rec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXNiukeTime(JuchuJuchuDataInRecord rec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXTojituSyuka(JuchuJuchuDataInRecord rec) {
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXUnsotenUnchin(JuchuJuchuDataInRecord rec, MastrTatesenOrositenRecord tatesenRec) {
		boolean res = true;
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXNiukeYoubi(JuchuJuchuDataInRecord rec) {
		ComUserSession cus = getComUserSession();
		String kaisyaCd = cus.getKaisyaCd(); // 会社CD
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXDuplicationShohinCd(JuchuJuchuDataInDtList editDtList, String shohinCd, int idx, int line) {
		boolean res = true;
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXZaikoSu(JuchuJuchuDataInDtRecord rec, int line) {
		// 在庫管理対象（製品または物品）のみ判定
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXSyukaSu(JuchuJuchuDataInDtRecord rec, int line) {
	 ...
	 */
	private boolean hasXDiffHtanka(JuchuJuchuDataInDtList editDtList, String kaisyaCd, String ktksyCd, boolean doSetStyleClass) {
	 ...
	 */
	private boolean hasXDiffCautionItem(JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInRecord hdRec) {
		boolean res = false;
		...
		for (PbsRecord cTmp : cautionList) {
			...
			for (PbsRecord eTmp : editDtList) {
				JuchuJuchuDataInDtRecord eDtRec = (JuchuJuchuDataInDtRecord) eTmp;
				// 商品CDがある場合のみ
	 ...
	 */
	private boolean checkXDiffYoreiHaisoSyohin(JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInRecord hdRec) {
		boolean res = true;
	 ...
	 */
	private boolean checkXDiffYoreiUnchinSyohin(JuchuJuchuDataInDtList editDtList, JuchuJuchuDataInRecord hdRec) {
		boolean res = true;
	 ...
	 * @return TRUE:要冷配送可能 / FALSE:要冷配送不可能
	 */
	private boolean checkXDiffYoreiHaisoUnchin(JuchuJuchuDataInRecord hdRec) {
		boolean res = true;
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXDiffTaruHosyoKin(JuchuJuchuDataInDtList editDtList) {
		boolean res = false;
	 ...
	 * @return TRUE:エラー無し / FALSE:何らかのエラー有り
	 */
	private boolean checkXDiffTaruTesuryo(JuchuJuchuDataInDtList editDtList) {
		boolean res = false;
	 ...
	 * @return TRUE:含まれている / FALSE:含まれていない
	 */
	private boolean hasHosyoKinTaisyo(JuchuJuchuDataInDtList editDtList) {
		boolean res = false;
	 ...
	 * @return TRUE:含まれている / FALSE:含まれていない
	 */
	private boolean hasTesuryoTaisyo(JuchuJuchuDataInDtList editDtList) {
		boolean res = false;
	 ...
	 * @return TRUE:含まれている / FALSE:含まれていない
	 */
	private boolean hasShohinAtBupinKbn(JuchuJuchuDataInDtList editDtList, String ... bupinKbn) {
		boolean res = false;
