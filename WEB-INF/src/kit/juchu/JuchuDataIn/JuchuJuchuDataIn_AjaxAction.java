...
public final class JuchuJuchuDataIn_AjaxAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuDataIn_AjaxFunction func_ = new JuchuJuchuDataIn_AjaxFunction(mapping, form, request, response);
