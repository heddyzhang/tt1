...
public final class JuchuJuchuDataIn_EditAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuDataIn_EditFunction func_ = new JuchuJuchuDataIn_EditFunction(mapping, form, request, response);
