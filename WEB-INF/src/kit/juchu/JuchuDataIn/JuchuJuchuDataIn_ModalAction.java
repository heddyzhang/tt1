...
public final class JuchuJuchuDataIn_ModalAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuJuchuDataIn_ModalFunction func_ = new JuchuJuchuDataIn_ModalFunction(mapping, form, request, response);
