...
public final class JuchuTuminiDenpyoHako_EditAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuTuminiDenpyoHako_EditFunction func_ = new JuchuTuminiDenpyoHako_EditFunction(mapping, form, request, response);
