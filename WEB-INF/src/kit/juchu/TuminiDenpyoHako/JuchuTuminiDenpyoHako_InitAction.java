...
public final class JuchuTuminiDenpyoHako_InitAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuTuminiDenpyoHako_InitFunction func_ = new JuchuTuminiDenpyoHako_InitFunction(mapping, form, request, response);
