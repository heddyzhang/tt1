...
public final class JuchuTuminiDenpyoHako_SearchAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		JuchuTuminiDenpyoHako_SearchFunction func_ = new JuchuTuminiDenpyoHako_SearchFunction(mapping, form, request, response);
