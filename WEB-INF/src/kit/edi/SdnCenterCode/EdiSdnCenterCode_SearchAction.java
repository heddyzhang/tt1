 ...
 *
 */
public final class EdiSdnCenterCode_SearchAction
	extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		EdiSdnCenterCode_SearchFunction func_ = new EdiSdnCenterCode_SearchFunction(mapping, form, request, response);
