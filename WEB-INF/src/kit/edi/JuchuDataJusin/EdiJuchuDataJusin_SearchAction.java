 ...
 *
 */
public final class EdiJuchuDataJusin_SearchAction
	extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		EdiJuchuDataJusin_SearchFunction func_ = new EdiJuchuDataJusin_SearchFunction(mapping, form, request, response);
