 ...
 *
 */
public class EdiSyuhantenReceiveUpdate_SearchFunction extends KitFunction {

	/** シリアルID */
	private static final long serialVersionUID = -15534761485918166L;


	// -----------------------------------------
	// create log4j instance & Config LogLevel
	// -----------------------------------------
	private static String className__ = EdiSyuhantenReceiveUpdate_SearchFunction.class.getName();
	 ...
	 */
	public EdiSyuhantenReceiveUpdate_SearchFunction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
