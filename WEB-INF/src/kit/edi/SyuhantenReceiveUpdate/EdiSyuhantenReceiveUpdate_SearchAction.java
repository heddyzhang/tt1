 ...
 *
 */
public final class EdiSyuhantenReceiveUpdate_SearchAction
	extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		EdiSyuhantenReceiveUpdate_SearchFunction func_ = new EdiSyuhantenReceiveUpdate_SearchFunction(mapping, form, request, response);
