...
public class EdiJuchuMainte_EditAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		EdiJuchuMainte_EditFunction func_ = new EdiJuchuMainte_EditFunction(mapping, form, request, response);
