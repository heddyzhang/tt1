...
public class EdiJuchuMainte_InitAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		EdiJuchuMainte_InitFunction func_ = new EdiJuchuMainte_InitFunction(mapping, form, request, response);
