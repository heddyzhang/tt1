...
public class EdiJuchuMainte_SearchAction extends KitAction {
	...
	protected String execute_(ActionMapping mapping, ActionForm form,
		...
		EdiJuchuMainte_SearchFunction func_ = new EdiJuchuMainte_SearchFunction(mapping, form, request, response);
