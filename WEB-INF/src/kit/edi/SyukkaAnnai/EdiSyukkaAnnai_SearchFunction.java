 ...
 *
 */
public class EdiSyukkaAnnai_SearchFunction extends KitFunction {
	...
	// -----------------------------------------
	private static String className__ = EdiSyukkaAnnai_SearchFunction.class.getName();
	 ...
	 */
	public EdiSyukkaAnnai_SearchFunction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
